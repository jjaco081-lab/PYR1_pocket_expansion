...
#SBATCH --output=logs/casc_stage2_%j.log
set -euo pipefail
...
$PY -u scripts/198_cascade2.py --procs 64 --out results/rfd3/cascade2.csv \
  --arms results/rfd3/batch03 results/rfd3/arm0a_s2026 results/rfd3/arm0b_s2027 \
         ...
         results/rfd3/arm5long_s5001 results/rfd3/arm5long_s5002 \
         results/rfd3/arm6helix_s6001 results/rfd3/arm6helix_s6002 \
         results/rfd3/arm7free_s7001
