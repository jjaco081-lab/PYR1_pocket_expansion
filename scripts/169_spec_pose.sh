...
#SBATCH -J specpose
#SBATCH -a 0-19%4
#SBATCH -o /bigdata/cutlerlab/jjaco081/PYR1_pocket_expansion/logs/specpose_%a.log
#
...
NAME=$(python3 -c "import json;print(json.load(open('$ROOT/data/poses/jobs_spec.json'))[$I]['compound'])")
SEED=$(python3 -c "import json;print(json.load(open('$ROOT/data/poses/jobs_spec.json'))[$I]['seed'])")
