...
#SBATCH -J mandipose
#SBATCH -a 0-9%4
#SBATCH -o /bigdata/cutlerlab/jjaco081/PYR1_pocket_expansion/logs/mandipose_%a.log
#
...
NAME=$(python3 -c "import json;print(json.load(open('$ROOT/data/poses/jobs_mandi.json'))[$I]['compound'])")
SEED=$(python3 -c "import json;print(json.load(open('$ROOT/data/poses/jobs_mandi.json'))[$I]['seed'])")
