...
#SBATCH -t 1:58:00
#SBATCH -J rfd0a
#SBATCH -o /bigdata/cutlerlab/jjaco081/PYR1_pocket_expansion/logs/rfd0a_%j.log
#
...
echo "contig: $CONTIG"
echo "NO burial conditioning -- this arm isolates the RASA variable"
